...
def main():
    ...
    # Salli ajo vain klo 07:00-08:29 UTC (= 10:00-11:29 Helsinki EEST/kesaaika)
    # Tama estaa myohaiset duplikaattiajot jos GitHub-jono viivastyi pahasti
    utc_now = datetime.now(timezone.utc)
    utc_minutes = utc_now.hour * 60 + utc_now.minute
    window_start = 7 * 60        # 07:00 UTC = 10:00 EEST
    window_end   = 8 * 60 + 29   # 08:29 UTC = 11:29 EEST
    if not (window_start <= utc_minutes <= window_end):
